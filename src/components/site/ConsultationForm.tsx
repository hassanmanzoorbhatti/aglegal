      ...
      <Reveal>
        <div className="flex min-h-[360px] flex-col items-center justify-center px-6 py-16 text-center">
          ...
          <p className="mt-4 max-w-[420px] font-grotesk text-[15px] leading-[1.7] text-clause-muted md:text-[16px]">
            ...
            step. For a faster response, you can also contact us directly on WhatsApp.
          </p>
          <button
            type="button"
        ...
        <div className="mt-9 grid grid-cols-1 gap-6">
          ...
          <div className="flex flex-col gap-2">
            <label htmlFor="service" className={labelBase}>
              Service <span className="text-clause-muted/60 normal-case tracking-normal">(optional)</span>
            </label>
            <select
              id="service"
              name="service"
